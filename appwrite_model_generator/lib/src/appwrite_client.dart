...
Library getLibary() => Library((lib) =>
    lib
      ..directives
      .add(Directive.import('package:appwrite/appwrite.dart'))
      ..directives
      .add(Directive.import('package:appwrite/models.dart'))
      ..directives
      .add(Directive.import('package:result_type/result_type.dart'))
      ..body
      .add(getClass()));
...
Method pageMethod() => Method((b) =>
    b
      ..name = 'page'
      ..types
      .add(refer('T extends AppwriteModel<T>'))
