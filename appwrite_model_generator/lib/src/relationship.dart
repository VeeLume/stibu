...
Library getLibary() => Library((lib) => lib
  ..body.add(getRelationshipType())
  ..body.add(getRelationshipOnDelete())
  ..body.add(getRelationshipSide())
  ..body.add(getClass()));
...
Enum getRelationshipType() => Enum((b) => b
  ..name = 'RelationshipType'
  ..values.addAll([
...
Enum getRelationshipOnDelete() => Enum((b) => b
...
Enum getRelationshipSide() => Enum((b) => b
