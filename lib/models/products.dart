...
@_i4.immutable
class Products extends _i5.AppwriteModel<Products> {
  const Products._({
    required this.id,
  ...
  factory Products.fromAppwrite(_i7.Document doc) => Products._(
        id: doc.data['id'],
  ...
  static Future<_i9.Result<(int, List<Products>), _i6.AppwriteException>> page({
    int limit = 25,
    int? offset,
    Products? last,
    List<String>? queries,
  ...
  Future<_i9.Result<(int, List<Products>), _i6.AppwriteException>> list(
  ...
  static Future<_i9.Result<Products, _i6.AppwriteException>> get(
    String documentId, {
    List<String>? queries,
  }) async =>
  ...
  Future<_i9.Result<Products, _i6.AppwriteException>> create(
  ...
  Future<_i9.Result<Products, _i6.AppwriteException>> update(
          {_i8.RelationContext? context}) async =>
