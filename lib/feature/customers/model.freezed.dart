...
class _$CustomerImpl extends _Customer with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Customer(id: $id, name: $name, email: $email, phone: $phone, street: $street, zip: $zip, city: $city)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, phone, street, zip, city);
...
abstract class _Customer extends Customer {
  factory _Customer(
      ...
      final String? street,
      final int? zip,
      final String? city}) = _$CustomerImpl;
  _Customer._() : super._();
